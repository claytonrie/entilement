...
TILE_COLOR.OUTER_TBL[TILE.GRAYED] = null;
...
var TILE_PROP = { TRAVEL_TBL: [], CHANGE_TBL: [] };
TILE_PROP.TRAVEL_TBL[TILE.GRAYED] = 0;
TILE_PROP.TRAVEL_TBL[TILE.BLUE]   = 1;
TILE_PROP.TRAVEL_TBL[TILE.RED]    = 2;
TILE_PROP.TRAVEL_TBL[TILE.GREEN]  = 3;
TILE_PROP.TRAVEL_TBL[TILE.PURPLE] = 0;
TILE_PROP.TRAVEL_TBL[TILE.ORANGE] = 1;
TILE_PROP.TRAVEL_TBL[TILE.STEEL]  = 1;
TILE_PROP.TRAVEL_TBL[TILE.DOUBLE_BLUE]   = -1;
TILE_PROP.TRAVEL_TBL[TILE.DOUBLE_RED]    = -2;
TILE_PROP.TRAVEL_TBL[TILE.DOUBLE_ORANGE] = 1;
TILE_PROP.TRAVEL_TBL[TILE.ORANGE_RED]    = 2;
TILE_PROP.TRAVEL_TBL[TILE.ORANGE_GREEN]  = 3;
TILE_PROP.TRAVEL_TBL[TILE.YELLOW]    = Infinity;
TILE_PROP.TRAVEL_TBL[TILE.ICE_BLUE]  = 1;
TILE_PROP.TRAVEL_TBL[TILE.ICE]       = 0;
TILE_PROP.TRAVEL_TBL[TILE.ICE_RED]   = 2;
TILE_PROP.TRAVEL_TBL[TILE.ICE_GREEN] = 3;
TILE_PROP.TRAVEL_TBL[TILE.WALL]      = 0;

TILE_PROP.CHANGE_TBL[TILE.GARYED] = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.BLUE]   = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.RED]    = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.GREEN]  = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.PURPLE] = TILE.PURPLE;
TILE_PROP.CHANGE_TBL[TILE.ORANGE] = TILE.BLUE;
TILE_PROP.CHANGE_TBL[TILE.STEEL]  = TILE.STEEL;
TILE_PROP.CHANGE_TBL[TILE.DOUBLE_BLUE]   = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.DOUBLE_RED]    = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.DOUBLE_ORANGE] = TILE.ORANGE;
TILE_PROP.CHANGE_TBL[TILE.ORANGE_RED]    = TILE.RED;
TILE_PROP.CHANGE_TBL[TILE.ORANGE_GREEN]  = TILE.GREEN;
TILE_PROP.CHANGE_TBL[TILE.YELLOW]    = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.ICE_BLUE]  = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.ICE]       = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.ICE_RED]   = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.ICE_GREEN] = TILE.GRAYED;
TILE_PROP.CHANGE_TBL[TILE.WALL]      = TILE.WALL;

var MOVE_IND_COLOR = [];
MOVE_IND_COLOR[SCOUT_CODE.INVALID] = COLOR.DARK_GRAY;
MOVE_IND_COLOR[SCOUT_CODE.VALID]   = COLOR.WHITE;
MOVE_IND_COLOR[SCOUT_CODE.END]     = COLOR.LIGHT_PURPLE;
